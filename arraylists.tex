...
\subsection{Size}
Now, we will add a size method to our list.
Fairly straightfoward in \texttt{Java}
...
It is worth reinforcing that by keeping track of the size in a variable and retrieving it, getting the size of our list is always $O(1)$
