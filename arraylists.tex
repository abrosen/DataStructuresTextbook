...
What about python?  Python deals with polymorphism using duck typing, originating from the idiom %\hyperref{``If it looks like a duck, swims like a duck, and quacks like a duck, then it probably is a duck''}{https://en.wikipedia.org/wiki/Duck\_test}
...
The last steps are important but not complicated: actually storing the item and then incrementing the size.
