...
Some Text
\begin{pycode}[label={thistest},listing and comment,comment={This is the classic hello world program}]{My Code}
def Hello():
    print("hello")
\end{pycode}
Other text

\begin{pycode}[]{My Code}
	def Hello():
	print("hello")
\end{pycode}


\begin{pycode}[label=green]{My Code}
def Hello():
	print("hello")
\end{pycode}

\begin{javacode}{Some Code}
