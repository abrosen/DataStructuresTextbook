...
\texttt{myThings = []} Does not actually make an array like you assume it would in some other language.  Instead it makes A list (specifically an arraylist ) to contain these items.

However, if you really want or need to use an array in python, you can.  There are 
...
\subsection{Retrieving a item stored at an index}

\subsection{Setting the value of an index}

\section{Array Internals}
